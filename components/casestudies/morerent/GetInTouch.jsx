    ...
    return (
        <div className='sm:px-14 px-6 bg-[#151E2C] w-full xxxl:min-h-fit sm:py-16 py-10'>
            <div className='max-w-screen-xxxl xxxl:mx-auto'>
                <div className='bg-[#FFBE62] rounded-lg sm:px-16 px-8 py-12 w-full flex flex-col sm:flex-row sm:justify-between sm:items-end xxxl:mt-10'> {/* Added justify-between and items-end */}  
